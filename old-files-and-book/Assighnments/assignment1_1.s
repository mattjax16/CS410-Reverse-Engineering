...
# assignment1_1.cpp -mtune=generic -march=x86-64 -g -fverbose-asm
...
.LFB1493:
	...
	subq	$16, %rsp	#,
# assignment1_1.cpp:6:  int width=10;
	.loc 1 6 0
	movl	$10, -12(%rbp)	#, width
# assignment1_1.cpp:7:  int height=5;
	.loc 1 7 0
	movl	$5, -8(%rbp)	#, height
# assignment1_1.cpp:9:  area = width * height;
	.loc 1 9 0
	movl	-12(%rbp), %eax	# width, tmp91
	imull	-8(%rbp), %eax	# height, tmp90
	movl	%eax, -4(%rbp)	# tmp90, area
# assignment1_1.cpp:11: cout<<endl<< area;
	.loc 1 11 0
	...
	movq	%rax, %rdx	#, _1
	movl	-4(%rbp), %eax	# area, tmp93
	movl	%eax, %esi	# tmp93,
	movq	%rdx, %rdi	# _1,
	call	_ZNSolsEi@PLT	#
# assignment1_1.cpp:12:  return 0;
	.loc 1 12 0
	movl	$0, %eax	#, _9
# assignment1_1.cpp:13: }
	.loc 1 13 0
	leave
	.cfi_def_cfa 7, 8
	ret
...
.LASF235:
	.string	"tm_wday"
.LASF466:
	.string	"/home/codio/workspace/Module1Files"
.LASF304:
